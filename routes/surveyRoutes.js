...
module.exports = app => {
  ...
  app.post('/api/surveys/webhooks', (req, res) => {
    ...
    //we can use a lodash helper called chain, chain let you pass an array to another continuously without assigning the outcome of the first one to a variable.
    _.chain(req.body)
      .map(({ email, url }) => {
